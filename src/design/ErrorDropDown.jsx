...
const ErrorDropDown = () => {
  ...
  const MyComponent = () => {
    ...
    return (
      <div className="w-56 mx-auto ml-80 mt-25 relative">
        <label
          className={
            "absolute left-3 px-1 transition-all bg-white text-red-600 " +
        ...
        <div
          className={
            "w-30 border rounded-md px-3 py-3 cursor-pointer " +
            "flex items-center justify-between transition " +
            (open ? "border-2 border-red-500" : "border-red-600")
          }
        ...
        >
          ...
          <ChevronDown
            className={
              "w-4 h-4 text-red-500 transition-transform " +
              (open ? "rotate-180" : "")
            }
          />
        </div>
