        ...
        <div className="relative flex items-center">
          <button
            ...
            className="absolute -left-14 top-1/2 -translate-y-1/2
             bg-white shadow-md rounded-full p-3 hover:bg-gray-100 transition"
          >
          ...
          <button
            onClick={nextSlide}
            className="absolute -right-14 top-1/2 -translate-y-1/2 bg-white shadow-md rounded-full p-3 hover:bg-gray-100 transition"
          >
         ...
         justify-center overflow-hidden rounded-2xl">
          <AnimatePresence custom={direction} mode="wait">
            <motion.div
              ...
              animate="center"
              exit="exit"
              className="absolute w-70 h-70 bg-gray-100 rounded-2xl shadow-lg
