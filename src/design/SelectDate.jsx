  ...
  const MyComponent = () => {
    ...
    return (
      <div className="flex justify-center items-center h-65">
        <div className="w-80 p-4 rounded-xl shadow-lg border bg-white relative">
          ...
          <button
            ...
            className="w-full flex justify-between items-center border rounded-lg px-3 py-2 text-sm bg-white shadow-sm hover:border-gray-400"
          >
          ...
          {showCalendar && (
            <motion.div
              ...
              className="absolute top-24 left-0 w-full bg-white border rounded-xl shadow-lg p-4 z-10 mt-2"
            >
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100">
      <div className="w-80 p-4 rounded-xl shadow-lg border bg-white relative">
        ...
        {showCalendar && (
          <div className="absolute top-24 left-0 w-full bg-white
           border rounded-xl shadow-lg p-4 z-10 mt-2">
            <div className="flex justify-between items-center mb-3">
              <button
                onClick={handlePrev}
                className="px-2 py-1 rounded hover:bg-gray-200"
            ...
            <div className="grid grid-cols-7 gap-y-1 text-gray-700">
              {cells}
            </div>
          </div>
        )}
