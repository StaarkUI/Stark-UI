          ...
          <div className="flex gap-2">
            {otp.map((digit, index) => (
              <input
                ...
                className="size-10 text-center border border-red-700 bg-red-400 rounded-lg text-lg font-medium
              focus:outline-none focus:ring-2 focus:ring-red-600 caret-red-700"
              />
            ))}
          </div>
